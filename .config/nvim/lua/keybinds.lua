...
map("n", ";c", function() require("conform").format({ async = true }) end, { desc = "Code Format" })
...
map("n", ";dd", function() require("dapui").toggle() end, { desc = "Toggle debug window" })
map("n", ";db", function() require("dap").toggle_breakpoint() end, { desc = "Set breakpoint" })
map("n", ";ds", function() require("dap").continue() end, { desc = "Start debugging" })
map("n", ";dn", function() require("dap").step_into() end, { desc = "Step into" })
